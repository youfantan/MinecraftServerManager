...
public class Main {
    ...
    public static void InstallServer() throws IOException, InterruptedException {
        ...
        long TakeTimel=EndTime-StartTime/1000;
        String TakeTime=String.valueOf(TakeTimel);
        logger.info("下载成功！耗时"+TakeTime+"秒");
        ...
        String RunServerBat="java -Xmx"+ServerStackMemory+"M"+" -jar "+"Server\\"+type+"-"+version+"-"+"Server.jar";
        ...
        logger.info("配置成功！耗时:"+taketime+"毫秒");
        logger.info("更改配置文件...");
